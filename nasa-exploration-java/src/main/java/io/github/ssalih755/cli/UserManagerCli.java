...
import io.github.ssalih755.dao.JdbcNeoDao;
import io.github.ssalih755.dao.JdbcUserDao;
import io.github.ssalih755.dao.NeoDao;
import io.github.ssalih755.model.Neo;
import io.github.ssalih755.model.NeoFeedResponse;
import io.github.ssalih755.model.User;
import io.github.ssalih755.dao.UserDao;
import io.github.ssalih755.security.PasswordHasher;
...
public class UserManagerCli {
    ...
    private void showNearEarthObjects() {
        ...
        NeoFeedResponse response = service.getNEOData(date + "", date.plusDays(7) + ""); // appending "" turns the date object into a String
    ...
    private void displayNeoObjects(NeoFeedResponse response, LocalDate date) {
        ...
        if (userInput.nextLine().equalsIgnoreCase("y")){
            ...
            String neoToSave = userInput.nextLine();
            boolean isFound = false;
            for (Neo n : neoList){
                if (n.getId().equalsIgnoreCase(neoToSave)){
...
//            loggedInUser.setUsername(username);
    ...
    private void printMenu() {
        ...
        System.out.println("(N)ear Earth Object");
